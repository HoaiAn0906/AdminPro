    ...
    <v-col cols="12">
      <v-row>
        <v-col cols="12" lg="6">
          ...
          <!-- Radialbar Chart -->
          <!-- ---------------------------------------------------- -->
          <ui-child-card title="Radialbar Chart">
            <apexchart height="300" :options="radialBarchartOptions" :series="radialBarChart.series" type="radialBar" />
          </ui-child-card>
        </v-col>
        <v-col cols="12" lg="6">
          <!-- ---------------------------------------------------- -->
          <!-- Radar Chart -->
          <!-- ---------------------------------------------------- -->
          <ui-child-card title="Radar Chart">
            <apexchart height="300" :options="radarOptions" :series="radarChart.series" type="radar" />
          </ui-child-card>
        </v-col>
      </v-row>
    </v-col>
