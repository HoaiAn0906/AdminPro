...
<template>
  ...
  <v-row>
    <v-col cols="12">
      <ui-parent-card title="Height Table">
              ...
              <tr v-for="item in heightTableData" :key="item.name" class="month-item">
                <td>
                  <div class="d-flex align-center">
                    <v-avatar rounded="md" size="42">
                      <img alt="avatar" height="42" :src="item.avatar" />
                    </v-avatar>
                    <div class="ml-4">
                      <h6 class="text-subtitle-1 text-no-wrap font-weight-bold">{{ item.name }}</h6>
                      <div class="text-subtitle-1 text-no-wrap font-weight-medium text-medium-emphasis mt-1">
                        {{ item.handle }}
                      </div>
                    </div>
                  </div>
